...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://193.112.243.111:3306/apolloportaldb";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "Root!!2018";
...
/*    private static final String JDBC_URL = "jdbc:oracle:thin:@112.74.212.112:1521/orcl";
    ...
    private static final String AUTHOR = "Miles";//@author
    ...
    public static void main(String[] args) {
        ...
        genCodeByCustomModelName("app", "App");
